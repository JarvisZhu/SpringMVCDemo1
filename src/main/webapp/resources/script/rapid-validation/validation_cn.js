...
Validator.messageSource['en-us'] = [
	...
	['validate-fax','Please enter a valid fax address.']
]
...
Validator.messageSource['zh-cn'] = [
	...
	['validate-alphanum' , '请输入英文字母开头以数字、下划线组合的字符串,其它字符是不允许的.'],
	...
	['validate-fax','请输入有效的传真地址.如：+123 -999 999']
]
...
Validation.addAllThese([
	...
	['validate-digits',/^[\d]+$/],		
	['validate-alphanum',/^[a-zA-Z]+[a-zA-Z0-9_]*$/],			
...
Validation.addAllThese([
	...
	['validate-mobile-phone',/(^((\+86)|(86))?(1)\d{10}$)/],
