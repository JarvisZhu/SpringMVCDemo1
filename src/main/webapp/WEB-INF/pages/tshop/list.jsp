...
<body>
<form id="queryForm" name="queryForm" method="get" action="${root}/tshop/page">
    ...
    <input type="submit" value="提交" onclick="getReferenceForm(this).action='${root}/tshop/page'"/>
    ...
    <table id="gl_main_menu_title" class="gl_main_menu_title" style="width: 100%;margin: 0 auto;" border="0" cellpadding="0" cellspacing="1" bgcolor="#e4e4e4">
        <tr>
            ...
            <th sortColumn="t.tuser.username" width="25%" height="45" align="center" bgcolor="#f7f9fb"><strong>username</strong></th>
            <th sortColumn="t.tuser.usercount" width="25%" height="45" align="center" bgcolor="#f7f9fb"><strong>usercount</strong></th>
            <!-- 上面排序字段值的写法，由于是hql查询，所以要写model中属性名 -->
        </tr>
        <c:forEach items="${page.result}" var="item" varStatus="status">
            <tr>
                ...
                <td width="25%" height="30" align="center" bgcolor="#FFFFFF"><c:out value='${item.tuser.username}'/>&nbsp;</td>
                <td width="25%" height="30" align="center" bgcolor="#FFFFFF"><c:out value='${item.tuser.usercount}'/>&nbsp;</td>
            </tr>
        </c:forEach>
    </table>
