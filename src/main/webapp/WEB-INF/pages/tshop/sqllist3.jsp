...
<body>
<form id="queryForm" name="queryForm" method="get" action="${root}/tshop/sqlpage3">
    ...
    <input type="submit" value="提交" onclick="getReferenceForm(this).action='${root}/tshop/sqlpage3'"/>
